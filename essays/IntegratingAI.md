...
<br>
<p>I used AI in the In-class Practice WODs because due to the time pressure of class ending or professor giving the answer I wanted to be sure that I gave myself a fair shot and used all of my resources. 
...
<br>  <img align="center" width="500px" class="rounded float-center pe-4" src="../img/IntegratingAI/murphys-home-page.png">
</p>
...
When it comes to comparing  traditional teaching methods with AI-enhanced approaches, there may or may not be an obvious winner. Traditional teachings can allow for a deeper, more cemented education, while AI-enhanced teaching is more fluid and maybe even brief. However, at the same time, software engineering may be impossible to learn everything traditionally because there is so much change happening in the technology world in general. With things constantly evolving and growing, trying to cement every little thing would never be enough because there will always be something new. Even AI itself is a growing system, idea, and tool where fluidity is almost essential to adapt to everything. 
<br>Along with the ability to be fluid with the evolving technological world, learning with AI-enhancements rather than traditional methods could also lead to more engagement with the students, since it is hands on and works towards each individuals' curiosity. If the student is able to dive into and learn about the things they are personally curious about, it could also lead to better retention since they are actively interested in it rather than learning a boring lecture topic.


### VII. Future Considerations:
I think AI is the future. AI will only get better, smarter, more efficient, useful, etc. Integrating AI into the software engineering educational process would only be beneficial to a student. Even if they use AI aggressively in the sense, they rely only on AI, they will still one day learn that AI won't always have their back. Plus, almost like the reverse psychology idea, trying to shield students from using AI only makes them want to use it more, except now it seems more as a "bad" thing so they tend to use it mischievously. However, if using AI is openly accepting, it could lead to a better and healthier relationship between students and AI, and it could allow them the chance to actually learn how to use AI most effectively.
