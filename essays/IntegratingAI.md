...
In the Software Engineering world specifically, AI tools such as ChatGPT, Github Co-Pilot, etc. are especially useful for software engineers because they can be used as a baseline for code or algorithms. Although AI is not always 100% accurate, we can use our knowledge with the combination of the AI's output to create more efficient code that we may not have thought of without the AI's help, or at least not as fast.
...
<br>
<br>
I used AI in our final projects Home Page/Landing Page when it came to adjusting the style of it all. I was able to refer to previous assignments when it came to the basic layout, but I had a hard time making the background image fit the screen perfectly, along with the navbar and footer. However, since ChatGPT can't import or export external sources (like my image), it was hard to get it to understand what my problem was. I eventually ended up asking "How to make the background image fit properly," which led it to give me some tips on how to adjust the CSS code to adjust an image size. With ChatGPTʻs tips and my knowledge from experience, I was able to play around with different patterns of the code which eventually gave me what I wanted.
<br>
...
<br>
<br>
If I needed to know a concept for an assignment, I most likely asked AI to help me understand it. When it came to knowing the difference between two similar things (like var vs. const vs. let), I asked ChatGPT. I have also used AI to help me relate certain concepts to things I might know in real-world applications.
<br>For example, I used AI to help me learn and understand Design Patterns and what ways I may have already used it. By knowing more in depth, I was able to write my essay about Design Patterns more efficiently. I started by asking ChatGPT "What are design patterns used for?" then asked "What are the most popular design patterns and some examples," then, if I had a specific design pattern in mind, I asked things like "Is this an example of a design pattern" along with some code to verify that I am correct in my thought process.


7. Answering a question in class or in Discord
<br> 
<br>
I did not use AI to answer questions in class or in Discord because I never really answered anyone's question. I know the Professor said it's beneficial if I did help others because it could broaden my own knowledge, but I never felt confident enough to answer someone else' question. To me, if I can use ChatGPT and try to answer the question, so could they. So, what made my answer so special or different from what they should have already tried?
...
<br>
<br>
I don't think I've used AI to completely write any of my code only because I knew there were certain things that it did and I hadn't learned yet so I could not verify if it was accurate or not. However, similar to #9, I used AI to give an example of what I was looking for which allowed me to copy certain lines of code.
...
<br>To say AI impacted my learning would be an understatement. I think AI has enhanced my learning to almost its fullest capacity, if not the fullest. Being able to practice and learn to have a healthy relationship with AI has been beneficial to me and my education because it taught me to not rely on AI, but to use it as an ally or tool. Just like it is important to collaborate with other people, I think it is also important to "collaborate" with AI, even if it is one-sided. Being able to see and learn of different approaches to coding, or life in general, is really important, and I think AI can be seen as just one of the many perspectives to view.


### IV. Practical Applications:
Some other practical applications of AI outside of ICS 314 would be other grammar/spelling checks, a possible outline for a creative short-story, a random name generator, a synonym generator, or even a calculator for complex calculations (like linear algebra). With many websites requiring payments or subscriptions, AI has been a free resource that I could consistently rely on as a tool. When it came to my Linear Algebra class, sometimes I needed an example solved, but I wanted to see the steps. However, on most websites like Symbolab or Mathway, it only showed limited steps (which were obvious and not that helpful) and required an account or some kind of payment to actually see the full solution. Sort of ironically, these calculators are far less helpful than AI because at least I could ask AI HOW they got the answer rather than just being provided the answer like the other calculators.


### V. Challenges and Opportunities:
The only challenge or limitation I would consider when it comes to using AI would be not being able to get an accurate answer and also, its database not being updated regularly leading to more older, outdated information. When it comes to getting an appropriate or useful answer, it really does depend on how you word your question, and what parts the AI picks up on. It may take multiple tries to get the AI to pick up on the right words, which is why it is important to write smart questions where there is no unnecessary information or extra words. I think one's ability to write a straightforward, to-the-point question weighs heavily on the output of the AI. On top of wording a question accurately, we also are assuming that the AI is up to date with accurate information. So, I would consider these two "problems" to be one of the challenges of using AI.
<br>I think further integration of AI in software engineering education is almost a necessity. I am grateful for the amount that we were allowed to use this semester in ICS 314, but being able to explore more about AI, and especially as it changes and grows overtime would be really interesting to see. Being given the opportunity to integrate AI into my education has made me a better question-asker, researcher (from verifying the information), and has broadened my overall knowledge.


### VI. Comparative Analysis:
When it comes to comparing  traditional teaching methods with AI-enhanced approaches, there may or may not be an obvious winner. Traditional teachings can allow for a deeper, more cemented education, while AI-enhanced teaching is more fluid and maybe even brief. However, at the same time, software engineering may be impossible to learn traditionally because there is so much changing in the technology world in general. With things constantly evolving and growing, trying to cement every little thing would never be enough because there will always be something new. Even AI itself is a growing system, idea, and tool where fluidity is almost essential to adapt to everything. 
<br>Along with the ability to be fluid with the evolving technological world, learning with AI-enhancements rather than traditional methods could also lead to more engagement with the students, since it is hands-on and works towards each individuals' curiosity. If the student is able to dive into and learn about the things they are personally curious about, it could also lead to better retention since they are actively interested in it rather than learning a boring and general lecture topic.


### VII. Future Considerations:
I think AI is the future. AI will only get better, smarter, more efficient, useful, etc. Integrating AI into the software engineering educational process would only be beneficial to a student. Even if they use AI aggressively in the sense, they rely only on AI, they will still one day learn that AI won't always have their back. Plus, almost like the reverse psychology idea, trying to shield students from using AI only makes them want to use it more, except now it seems more as a "bad" thing so they tend to use it mischievously. However, if using AI is openly accepted, it could lead to a better and healthier relationship between students and AI, and it could allow them the chance to actually learn how to use AI most effectively.
<br>I think the biggest challenge in incorporating AI into the software engineering education system would be to teach a student to differentiate when the AI is wrong. Providing a student with lecture videos, readings, and screen-casts allows them to visualize and learn what is literally by-the-book correct, which they can use to their discretion to evaluate the AI's responses' accuracy.


### VIII. Conclusion:
Integrating AI in the Software Engineering course was the best decision the professors made for students of the course. Being able to treat AI as a resource rather than a cheating platform was very informative because it allowed me to learn to ask proper questions and check what the AI produced with what I've seen and learned throughout the course. Having the freedom and option to use AI also removed the pressure of having to use AI to complete an assignment or strictly use our knowledge to complete it. Being able to practice using AI efficiently allowed me to gain a sense of what the real-world might be like. We will almost always have access to some form of technology and AI, and learning to use it to benefit me and my situation best was a skill I never thought I'd really value that much.
<br>If I had any recommendation or suggestion for optimizing the integration of AI in the future, I would maybe look into how AI works. I did a project in a previous semester where I discussed and researched how ChatGPT specifically works and where it gets its data from, however, I don't think everyone knows. For example, I know not everyone knows ChatGPT uses a set data that was last taken a few years ago, leading to some outdated information, which can affect what one may decide to ask the AI and/or how. 